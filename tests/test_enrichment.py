"""
Automated Pytest for bmi-zscore-who-calculator Enrichment Modules.
"""
import sys
...
from enrichment import (
    EnrichmentmdEngine,
    LongitudinalGrowthTrackingEngine,
    ...
    BmizscorewhocalculatorEnrichmentSuite,
    enrichment_suite,
)

def test_enrichment_suite_execution():
    suite = BmizscorewhocalculatorEnrichmentSuite()
