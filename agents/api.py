"""
FastAPI REST API Server for Bmi Zscore Who Calculator.
"""
...
app = FastAPI(
    title="Bmi Zscore Who Calculator API",
...
@app.get("/health")
def health():
    return {"status": "HEALTHY", "service": "bmi-zscore-who-calculator", "domain": "Clinical & Biomedical AI", "standard": "CAP / CLSI / ISO Standards", "version": "3.0.0-ENTERPRISE"}
